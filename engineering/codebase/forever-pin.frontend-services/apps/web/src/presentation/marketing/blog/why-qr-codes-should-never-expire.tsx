  ...
  Body: () => (
    <>
      ...
      <p>
        ...
        <code>foreverpin.com/aB3x9</code>). When scanned, that link looks up your real destination and
      ...
      <p>
        ForeverPin was built around the opposite promise: your codes never expire and never deactivate
