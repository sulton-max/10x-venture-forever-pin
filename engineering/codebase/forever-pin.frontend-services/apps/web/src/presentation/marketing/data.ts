...
// Marketing-surface source of truth (pricing, features, comparison, steps, FAQs). Keep prices in sync with `ideas/forever-pin-spec.md` §9 and `business/business-knowledge.md`.
