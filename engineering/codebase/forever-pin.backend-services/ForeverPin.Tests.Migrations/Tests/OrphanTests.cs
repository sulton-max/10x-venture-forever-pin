...
using ForeverPin.Tests.Migrations.Harness;
using WoW.Two.Sdk.Backend.Beta.Testing.Data.Migrations;
using WoW.Two.Sdk.Backend.Beta.Data.Migrations.Bespoke;

namespace ForeverPin.Tests.Migrations.Tests;
...
public sealed class OrphanTests(MigratorPostgresFixture fixture) : MigratorTestBase(fixture)
{
    ...
    public async Task ApplyPending_WithOrphanAllowed_Proceeds()
    {
        ...
        // A migrator that tolerates orphaned history applies the (now-only) pending work without throwing.
