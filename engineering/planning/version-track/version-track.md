...
Each version under `v{X.Y}/v{X.Y}.md` — `v0.1` (foundation) · `v0.2` (migration layer) · `v0.3` (accounts) · `v0.4` (SDK adoption) · `v0.5` (code styling) · `v0.6` · `v0.7` (static content + export) · `v0.9` (content mode — static/dynamic; **next Feature**) · `v0.11` (interactive landing hero — **experiment**, renumbered off v0.9 on 2026-07-18).
